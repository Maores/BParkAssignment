...
import client.controller.RemoteScreen;
import client.controller.StaffGui;
import client.controller.UserLoginAccess;
import client.controller.UserManagementScreen;
...
public class MainApp extends Application {
	...
	public void showLoginScreen() throws Exception {
		this.userId = null;
		this.userName = null;
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/fxml/userLogin.fxml"));
...
//            Parent root = parkingSystemGUI.buildRoot();
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/fxml/userAccessOptionsGUI.fxml"));
			Parent root = loader.load();
