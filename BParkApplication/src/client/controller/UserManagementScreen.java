...
public class UserManagementScreen implements ChatIF {
	...
	private void openSubscriberStatusReport() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/fxml/ReportScreen.fxml"));
	...
	private void openParkingDurationReport() {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/fxml/parking_timing_report.fxml"));
			Parent root = loader.load();
	...
	private void generateReport() {
		...
		dialog.getDialogPane().getStylesheets().add(getClass().getResource("/common/appStyle.css").toExternalForm());
