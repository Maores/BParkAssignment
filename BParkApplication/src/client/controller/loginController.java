...
public class loginController implements ChatIF {
	...
	private void forgotPass() {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/fxml/ForgotPassword.fxml"));
		Parent pop;
		try {
			pop = loader.load();
	...
	public void showQR() {
		...
		Image image = new Image(getClass().getResource("/client/imgs/QR_code.png").toExternalForm());
		view.setImage(image);
