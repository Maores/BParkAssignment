...
/**
 * GUI controller for entering a confirmation code to deliver a car on-site in
 * the BPark system.
 */
...
public class ShowCodeScreenDeliverController {
	...
	/**
	 * Builds the root layout for the confirmation code input screen. Includes a
	 * label, input field, and a button to submit the code.
	 * 
